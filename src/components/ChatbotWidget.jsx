      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed bottom-22 right-6 z-[9999] w-[340px] sm:w-96 h-[520px] flex flex-col rounded-2xl glass-panel-strong overflow-hidden shadow-[0_12px_45px_rgba(0,0,0,0.08)] border border-white/90"
          >
            {/* Header */}
